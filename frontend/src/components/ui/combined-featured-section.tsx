  ...
  return (
    <AuroraBackground>
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 md:grid-rows-2 gap-6">
        ...
        {/* 1. MAP - Top Left */}
        <LiquidGlassBorder variant="default" className="overflow-hidden bg-muted p-4">
        ...
        <LiquidGlassBorder variant="subtle" className="flex flex-col justify-between gap-4 p-6 bg-card">
          <div>
        ...
        {/* 3. CHART - Bottom Left */}
        <LiquidGlassBorder variant="default" className="bg-muted p-6 space-y-4">
          <div className="flex items-center gap-2 text-sm text-gray-500 mb-4">
        ...
        <LiquidGlassBorder variant="subtle" className="grid sm:grid-cols-2 bg-card">
          <FeatureCard
